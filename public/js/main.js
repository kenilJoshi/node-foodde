...
var bookMarkHotel = document.getElementById("bookMarkbtn1");
var likedFood = document.querySelectorAll(".btn4");
var fullProfileNavigator = document.querySelector(".fullProfileNavigator");
var profileClick = document.getElementById("userProfile");
var reviewsCompartment = document.getElementById("reviewsCompartment");
var orderOnline = document.getElementById("orderOnline");
var fullOnlineOrder = document.querySelector(".fullOnlineOrder");
var reviews = document.querySelector(".reviews");

function updateCart(food) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/updateCart", food).then(function (res) {
    console.log(res);
  ...
  fetch("/updateBookmark", {
    ...
    if (status.status === "deleted") {
      ...
      new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
        type: "success",
        timeout: 1000,
        text: "".concat(hotel.name, " BookMark is removed")
      }).show();
    } else {
      ...
      new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
        type: "success",
        timeout: 1000,
        text: "".concat(hotel.name, " is BookMarked")
      }).show();
    }
  });
}

bookMarkHotel.addEventListener("click", function () {
  var hotel = JSON.parse(bookMarkHotel.dataset.hotel);
  console.log(bookMarkHotel.className);
  var user = bookMarkHotel.dataset.user;
  ...
  if (user === "Please Login") {
    ...
    var fullUser = JSON.parse(user);
    updateBookMark(hotel, fullUser, bookMarkHotel);
  }
});

function likeByUser(food) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/likedFood", food).then(function (res) {
    if (res) {
      new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
        type: "error",
        timeout: 1000,
...
likedFood.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var food = JSON.parse(btn.dataset.food);
    console.log(food);
    likeByUser(food);
...
orderOnline.addEventListener("click", function (e) {
...
reviewsCompartment.addEventListener("click", function (e) {
