...
var bookMarkHotel = document.getElementById("bookMarkbtn1"); // const bookMarkDelete = document.getElementById("bookMarkbtn2");
...
function updateCart(food) {
  axios__WEBPACK_IMPORTED_MODULE_1___default().post("/updateCart", food).then(function (res) {
    console.log(res);
...
function updateBookMark(hotel) {
  axios__WEBPACK_IMPORTED_MODULE_1___default().post("/updateBookmark", hotel).then(function (res) {
    if (err) {
      new (noty__WEBPACK_IMPORTED_MODULE_2___default())({
        type: "error",
        timeout: 1000,
...
function likeByUser(food) {
  axios__WEBPACK_IMPORTED_MODULE_1___default().post("/likedFood", food).then(function (res) {
    if (res) {
      new (noty__WEBPACK_IMPORTED_MODULE_2___default())({
        type: "error",
        timeout: 1000,
